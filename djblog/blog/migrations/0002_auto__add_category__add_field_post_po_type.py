...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.po_type'
        db.add_column(u'blog_post', 'po_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.po_type'
        db.delete_column(u'blog_post', 'po_type_id')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'po_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Category']", 'null': 'True', 'blank': 'True'}),
